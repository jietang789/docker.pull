...
///
Command Line Tools
helm,helmfile,kaniko,kapp,kpt,kubectl,kustomize,mink,octant,skaffold,tekton,terraform

Microservices
CNCF build packs,cert-manager,external-dns,knative,kuberhealthy,kubernetes external secrets,jenkins,jenkinsfile runner,lighthouse,push-wave,tekton pipelines,tekton catalog,vault,vault operator
